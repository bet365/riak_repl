...
init([]) ->
    Processes =
        [
            ...
            {riak_repl2_reference_rtq_sup, {riak_repl2_reference_rtq_sup, start_link, []},
            permanent, infinity, supervisor, [riak_repl2_reference_rtq_sup]},
            ...
            %% This is no longer important, if it dies, let it restart by itself
