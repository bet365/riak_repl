        ...
        [{setup,
            ...
            fun(_) -> [
                ...
                {"get ipaddrs of cluster with unknown name", fun() ->
                    ?_assert({ok,[]} == riak_core_cluster_mgr:get_ipaddrs_of_cluster_single("unknown"))
                end},
                ...
                %% todo, maybe add here or in new test-suite for riak_repl2_rtsource_conn_mgr tests for connectivity to cluster based on settings
            ]
        end
    }
]}.
