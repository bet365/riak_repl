...
start_link(SiteName, Transport, Socket, WorkDir, Client, Proto, FullsyncObjectFilter) ->
    gen_fsm:start_link(?MODULE, [SiteName, Transport, Socket, WorkDir, Client, Proto, FullsyncObjectFilter], []).
...
init([SiteName, Transport, Socket, WorkDir, Client, Proto, FullsyncObjectFilter]) ->
...
wait_for_individual_partition(Partition, State=#state{work_dir=WorkDir, fullsync_object_filter = FullsyncObjectFilter}) ->
